 ...
 */
package com.trivialjava.rnd.interceptors;
 ...
 */
@ManagedResource
public class TimingInterceptor extends ChannelInterceptorAdapter {

	private ThreadLocal<StopWatchHolder> stopWatchHolder = new ThreadLocal<TimingInterceptor.StopWatchHolder>();

	private Map<Class<?>, Stats> statsMap = new ConcurrentHashMap<Class<?>, TimingInterceptor.Stats>();
	 ...
	 */
	public TimingInterceptor(Class<?>[] classes) {
